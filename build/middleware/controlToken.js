...
var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var token, authorization, decodeToken, SQL_Usuarios, pool, resultado;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            token = null;
            authorization = req.get("Authorization"); // cago el token de la cabecera
          ...
          case 6:
            ...
            decodeToken = _jsonwebtoken["default"].verify(token, process.env.ClaveSecretaJWT); // decodificamos el token -> invalid token
          ...
          case 11:
            ...
            SQL_Usuarios = "select * from Usuarios as Us where Us.id = ".concat(decodeToken.id);
            _context.next = 14;
            return (0, _connection.getConnection)();
          case 14:
            pool = _context.sent;
            _context.next = 17;
            return pool.request().query(SQL_Usuarios);
          case 17:
